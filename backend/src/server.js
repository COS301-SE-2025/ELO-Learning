...
const TOKEN_EXPIRY = 3600; // 1 hour in milliseconds
...
app.post('/users/:userId/achievements/progress', async (req, res) => {
  try {
    const { userId } = req.params;
...
// New endpoint: Get all achievements with user progress (for achievements page)
