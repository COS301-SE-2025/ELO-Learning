...
describe('Achievement Notification Manager Component', () => {
  ...
  it('mounts and sets up global functions', () => {
    ...
    cy.window().should('have.property', 'showAchievement').and('be.a', 'function')
    cy.window().should('have.property', 'showMultipleAchievements').and('be.a', 'function')
  })
  ...
  it('displays single achievement notification', () => {
    ...
    cy.contains('Testing achievement display in component test').should('be.visible')
  ...
  it('positions multiple notifications correctly', () => {
    ...
    cy.contains('Middle Achievement').parent().should('have.css', 'top', '140px')
    
    // Third notification should be even lower (260px = 20 + 2*120)
    cy.contains('Bottom Achievement').parent().should('have.css', 'top', '260px')
  })

  it('cleans up global functions on unmount', () => {
    cy.mount(<AchievementNotificationManager />).then(({ component, rerender }) => {
...
describe('Achievement Notification Component', () => {
  ...
  it('renders when show is true', () => {
    ...
    cy.contains('This is a test achievement for component testing').should('be.visible')
    cy.contains('Testing').should('be.visible')
  })
