...
describe('Landing Page Components', () => {
  describe('LandingHeader Component', () => {
    ...
    it('should render mobile logo on mobile viewport', () => {
      ...
      cy.get('img[alt="ELO Learning Mascot"]').should(
        'have.class',
        'md:hidden',
      );
    });
    ...
    it('should have correct image attributes', () => {
      ...
      cy.get('img[src="/ELO-Logo-Horizontal.png"]').should(
        'have.attr',
        'width',
        '150',
      );
      ...
      cy.get('img[src="/ELO-Learning-Mascot.png"]').should(
        'have.attr',
        'width',
        '50',
      );
  ...
  describe('LandingFooter Component', () => {
    ...
    it('should render mobile logo on mobile viewport', () => {
      ...
      cy.get('img[src="/Light-horizontal.png"]').should(
        'have.class',
        'md:hidden',
      );
      cy.get('img[src="/Light-horizontal.png"]').should(
    ...
    it('should have working external link', () => {
      ...
      cy.get('a[href="https://proking.solutions/"]').should(
        'have.attr',
        'target',
        '_blank',
      );
    ...
    it('should display links in correct order', () => {
      ...
      const linksContainer = cy
        .get('.flex.flex-row.gap-2.justify-between > div')
        .first();
    ...
    it('should maintain consistent styling', () => {
      ...
      // Check link styling
      cy.get('a[href="https://proking.solutions/"] span').should(
        'have.class',
        'underline',
      );
    });
