  ...
  useEffect(() => {
    async function fetchQuestions() {
      try {
        ...
        console.log('Fill-in-the-Blank questions fetched successfully:', fetchedQuestions.length);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <h2 className="text-xl font-semibold text-gray-800">Loading Fill-in-the-Blank Questions...</h2>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center p-8 max-w-md">
          ...
          <h2 className="text-2xl font-bold mb-4 text-red-red-600">Error Loading Questions</h2>
