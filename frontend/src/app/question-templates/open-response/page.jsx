  ...
  useEffect(() => {
    async function fetchQuestions() {
      try {
        ...
        console.log('Open Response questions fetched successfully:', fetchedQuestions.length);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center p-8">
          ...
          <h2 className="text-xl font-semibold text-gray-800">Loading Open Response Questions...</h2>
