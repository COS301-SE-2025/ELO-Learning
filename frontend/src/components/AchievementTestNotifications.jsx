...
export default function AchievementTestNotifications() {
  ...
  const testNotificationSystem = () => {
    ...
    if (window.showAchievement) {
      ...
      setTestResult(
        '✅ Multiple notifications ready - showing test achievement',
      );
      ...
      console.log(
        ...
        Object.keys(window).filter(
          (k) => k.includes('Achievement') || k.includes('show'),
        ),
      );
    }
  };
  ...
  const testDelayedNotification = () => {
    console.log(
      '🧪 Testing delayed notification (simulating real gameplay)...',
    );
    ...
    const testAchievement = {
      ...
      name: 'Delayed Test',
      description:
        'Testing delayed achievement notification like in real gameplay',
      condition_type: 'Test',
      condition_value: 1,
  ...
  return (
    <div className="bg-blue-900 border border-blue-600 rounded-lg p-4 mb-4">
      ...
      <div className="text-gray-400 text-xs mt-3">
        <p>
          Use these tests to verify the notification system works during
          gameplay scenarios.
        </p>
      </div>
    </div>
