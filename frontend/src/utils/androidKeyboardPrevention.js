 ...
 */
export const applyAndroidKeyboardPrevention = (element, preventKeyboard = true) => {
 ...
 */
export const attachNonPassiveTouchHandler = (element, preventKeyboard = true) => {
  const browserInfo = getAndroidBrowserInfo();
  ...
  const handleResize = () => {
    ...
    if (keyboardNowVisible !== isKeyboardVisible) {
      ...
      if (isKeyboardVisible) {
        console.warn('Android keyboard appeared unexpectedly, attempting to close...');
