...
jest.mock('../../../../src/app/ui/achievements/achievement-badge', () => {
  return function MockAchievementBadge({ achievement, unlocked, size, progress, showProgress }) {
    return (
      <div data-testid="achievement-badge">
        <span data-testid="badge-name">{achievement.name}</span>
        <span data-testid="badge-unlocked">{unlocked ? 'unlocked' : 'locked'}</span>
...
describe('AchievementNotification', () => {
  ...
  describe('Component Rendering', () => {
    it('renders notification when show is true', () => {
      ...
      expect(screen.getByText('A test achievement for unit testing')).toBeInTheDocument()
    })
  ...
  describe('Achievement Badge Integration', () => {
    it('renders achievement badge with correct props', () => {
      ...
      expect(screen.getByTestId('badge-unlocked')).toHaveTextContent('unlocked')
  ...
  describe('Visual Effects and Animation', () => {
    it('applies correct CSS classes for visibility', () => {
      ...
      expect(notificationElement).toHaveClass('translate-y-0', 'opacity-100', 'scale-100')
    })
    ...
    it('renders sparkle animation elements', () => {
      ...
      const sparkles = container.querySelectorAll('.absolute.w-1.h-1.rounded-full')
  ...
  describe('Different Achievement Types', () => {
    it('handles streak achievements', () => {
      ...
      expect(screen.getByText('Answer 5 questions in a row correctly')).toBeInTheDocument()
    ...
    it('handles badge collection achievements', () => {
      ...
      expect(screen.getByText('Unlock 10 different achievements')).toBeInTheDocument()
  ...
  describe('Error Handling', () => {
    ...
    it('handles achievement with missing description', () => {
      ...
      expect(screen.getByText('🎉 Achievement Unlocked!')).toBeInTheDocument()
      expect(screen.getAllByText('Name Only Achievement')[0]).toBeInTheDocument()
    })
  })
