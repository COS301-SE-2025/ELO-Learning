...
interface Subcategory {
  ...
  name: string;
  description: string;
  completion?: number; // Optional since it's commented out but might be used later
}
...
export default function SubCategories({ subcategories }: SubCategoriesProps) {
  return (
    <div className="p-5">
