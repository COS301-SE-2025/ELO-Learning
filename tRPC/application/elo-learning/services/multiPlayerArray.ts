...
export function calculateExpected(p1: number, p2: number): [number, number] {
...
export function distributeXPFromResults(
  player1Results: QuestionResult[],
  player2Results: QuestionResult[],
